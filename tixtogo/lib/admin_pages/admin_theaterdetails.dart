...
import 'admin_theaters.dart'; // Import the admin theater editing page

class AdminTheaterdetails extends StatelessWidget {
  final Map<String, dynamic> theater;
  final VoidCallback onUpdate;

  const AdminTheaterdetails({
    super.key,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            // Navigate to AdminTheaters for editing
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder:
                                    (context) =>
                                        AdminTheaters(theaterToEdit: theater),
                              ),
                            ).then((_) => onUpdate()); // Refresh after editing
                          },
